...
void setup() 
{
  ...
  if(!wifiManager.autoConnect("MyASUS","abhushan"))                   //wifiManager.autoConnect("AP-NAME", "AP-PASSWORD"); (OR) wifiManager.autoConnect("AP-NAME"); only ID no password (OR) wifiManager.autoConnect(); this will generate a ID by itself
  {
...
///////////////////////////////////////////////////////////////////////////////
  ...
  String PostValue = "{\"device_id\":  61121695810, \"slave_id\": 2";
         PostValue = PostValue + ",\"dts\":" +timestamp;
   PostValue = PostValue +",\"data\":{\"IR \":" + value +"}"+"}";
